        ...
        <div className="px-6 py-8">
            <div className="container flex justify-between mx-auto">
                ...
                <div className="w-full lg:w-8/12">
                    ...
                    <div className="mt-4">
                        <div className="max-w-4xl px-10 py-6 mx-auto bg-white rounded-lg shadow-md shadow-black">
                            <div className="mt-2"><p className="text-2xl font-bold text-gray-700">About Us:</p>
                    ...
                    <div className="mt-6">
                        <div className="max-w-4xl px-10 py-6 mx-auto bg-white rounded-lg shadow-md">
                            ...
                            <div className="mt-2"><a href="#" className="text-2xl font-bold text-gray-700 hover:underline">Learning new javascript concepts.</a>
                                <p className="mt-2 text-gray-600">Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                                    Tempora expedita dicta totam aspernatur doloremque. Excepturi iste iusto eos enim
                                    reprehenderit nisi, accusamus delectus nihil quis facere in modi ratione libero!</p>
                            </div>
                            <div className="flex items-center justify-between mt-4"><a href="#"
                                ...
                                <div><a href="#" className="flex items-center">
                                        <h1 className="font-bold text-gray-700 hover:underline">Jared</h1>
                                    </a></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mt-8">
                        <div className="flex">
                            <a href="#" className="px-3 py-2 mx-1 font-medium text-gray-500 bg-white rounded-md hover:bg-gray-500 hover:text-white">
                                Previous
                            </a>
                ...
                <div className="hidden w-4/12 -mx-8 lg:block">
                    ...
                    <div className="px-8 mt-10">
                        <h1 className="mb-4 text-xl font-bold text-gray-700">Contributors</h1>
                        <div className="flex flex-col max-w-sm px-4 py-6 mx-auto bg-white rounded-lg shadow-md">
                            <ul>
                            <li className="flex items-center">
                                    <p><a href="#" className="mx-1 font-bold text-gray-700 hover:underline">Jared</a><span
                                            className="text-sm font-light text-gray-700">Joined 2/6/2024</span></p>                
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div className="px-8 mt-10">
                        <h1 className="mb-4 text-xl font-bold text-gray-700">Most Recent Post</h1>
                        <div className="flex flex-col max-w-sm px-8 py-6 mx-auto bg-white rounded-lg shadow-md">
                            <div className="mt-4"><a href="#" className="text-lg font-medium text-gray-700 hover:underline">Learning new javascript concepts.</a></div>
