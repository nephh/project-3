...
function NavTabs() {
  ...
  return (
    <>
    <nav className="border-gray-200 bg-white dark:bg-gray-900 sticky w-full top-0">
    ...
    {/* Mobile menu */}
    {isOpen && (
      <div className="md:hidden py-4 flex flex-col basis-full flex-wrap items-center justify-center bg-gray-100 dark:bg-gray-900">
        <Link
          to={Auth.loggedIn() ? "/dashboard" : "/login"}
